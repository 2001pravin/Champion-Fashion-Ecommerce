        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 text-left maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:tect-xl text-gray-900 mt-6">
          ...
          <div className=" border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="text items-center space-x-3">
                  <Rating value={4.6} precision={4.5} readOnly></Rating>
                  <p className="opacity-60">576896 Ratings</p>
                </div>
